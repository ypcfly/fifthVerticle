  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "insertNewUser": {
          service.insertNewUser((io.vertx.core.json.JsonArray)json.getValue("jsonArray"), createHandler(msg));
          break;
        }
        case "queryByUserName": {
          service.queryByUserName((java.lang.String)json.getValue("username"), (java.lang.String)json.getValue("password"), createHandler(msg));
          break;
        }
        case "queryAllUser": {
          service.queryAllUser(createHandler(msg));
          break;
        }
